      ...
      <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
        ...
        <div class="block w-full overflow-x-scroll">
          ...
          <div class="flex-auto px-4 lg:px-10 py-10 pt-0 bg-gray-100">
            <form method="POST" action="<?php echo base_url() ?>car/car_new_process">
              <br>
              ...
              <div class="flex flex-wrap">
                <div class="w-full lg:w-12/12 px-4">
                  <div class="relative w-full mb-3">
                    ...
                    <input type="text" name="car_name" class="px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full ease-linear transition-all duration-150" required/>
                  </div>
                  <div class="relative w-full mb-3">
                    <label class="block uppercase text-gray-700 text-xs font-bold mb-2" htmlFor="grid-password" >
                      Police Number
                    </label>
                    <input type="text" name="police_number" class="px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full ease-linear transition-all duration-150" required />
                  </div>
